...
class Main extends React.Component {
    onSearchButtonClick = () => {
      ...
      state = {
        ...
        page: 1,
        url: `https://api.themoviedb.org/3/genre/movie/list?api_key=8c6315630bb0afb677738faabaf64b57&language=en-US`,    
...
fetchMovies = (url) => {
    ...
    generateUrl = params => {
        ...
        const moviesUrl = `https://api.themoviedb.org/3/discover/movie?` +
          `api_key=8c6315630bb0afb677738faabaf64b57&` +
      ...
      componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.moviesUrl !== prevState.moviesUrl && prevProps.moviesUrl !== this.state.moviesUrl) {
          this.fetchMovies(prevState.moviesUrl);
        }
        if (this.state.page !== prevState.page) {
          this.generateUrl(prevState);
        }
    }
      storeMovies = data => {
